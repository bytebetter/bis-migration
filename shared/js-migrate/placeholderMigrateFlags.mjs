...
export const ENSURE_PLACEHOLDER_PATIENT_INFO_ENABLED = true;
/** สร้างแถว appointment "ไม่ทราบชื่อ" ผ่าน ensurePlaceholderAppointment (examination ฯลฯ) */
export const ENSURE_PLACEHOLDER_APPOINTMENT_ENABLED = true;
/** logic ใน migrate patient_info (จำแนก placeholder + insert-only ทับ placeholder) */
export const PATIENT_INFO_MIGRATE_PLACEHOLDER_LOGIC_ENABLED = true;
/** logic ใน migrate appointment (ensure patient + insert-only ทับ placeholder) */
export const APPOINTMENT_MIGRATE_PLACEHOLDER_LOGIC_ENABLED = true;
